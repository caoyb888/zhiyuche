...
import type { BadgeClass, ChargerStatus } from '../types'
import { AlertTriangle, CheckCircle, Clock } from 'lucide-react'

const pileStatusStyle: Record<ChargerStatus, { dot: string; badge: BadgeClass; bg: string }> = {
...
export default function ChargingPage() {
  ...
  const stats: Array<[label: string, value: string | number, color: string, bg: string]> = [
    ...
    <div className="space-y-5 slide-up">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
          {chargers.map(pile => {
            const s = pileStatusStyle[pile.status]
            return (
      ...
      {/* History toggle */}
      <div className="card">
        <button type="button" onClick={() => setHistory(h => !h)}
